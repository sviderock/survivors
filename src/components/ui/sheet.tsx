...
const SheetContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <SheetPortal position={local.position}>
      ...
      >
        {local.children}
        <SheetPrimitive.CloseButton class="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
          <svg
